...
<div class="container">
                ...
                <div class="row row-cols-2 row-cols-md-3 g-4 justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-2" id="construction">
                        <div class="ebook" data-bs-toggle="tooltip" data-bs-placement="right" title="Sistem Informasi Administrasi Kepala Daerah & DPRD">
                            <div class=" card box-item-image ms-1 border-0" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="100">
                                <a href="">
    ...
    <div class="row">
        <?php foreach ($agendaLimit as $a) : ?>
            <div class="col-sm-6">
                <div class="card img-shadow mb-3 border-0" data-aos="fade-right" data-aos-duration="1100" data-aos-offset="100">
                    <div class="row g-0">
                        <div class="col-md-4">
