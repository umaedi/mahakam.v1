            ...
            <div class="card shadow mb-4">
                <div class="card-header">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url(); ?>/administrator/users" class="d-none d-sm-inline-block btn btn-sm btn-info"><i class="fas fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="/administrator/update_user/<?= $user['id']; ?>" method="post" enctype="multipart/form-data">
