        ...
        <?php foreach ($bupati as $b) : ?>
            <div class="col-lg-3 col-md-3 col-sm-12">
                <div class="card shadow mb-4">
                    ...
                    <p class="text-center px-2 font-italic"><span class="font-weight-bold">Motto</span><br><?= $b['motto']; ?></p>
                </div>
            </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <a href="<?= base_url(); ?>/administrator/bupati/edit_bupati/<?= $b['id']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-info"><i class="far fa-edit text-white-50"></i> Edit Biografi</a>
                        </div>
                    </div>
                    <div class="card-body">
